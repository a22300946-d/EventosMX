      ...
      <div className="sr-root">
        ...
        <header className="sr-header">
          <div className="sr-header-left">
            ...
            <div>
              ...
              <p>Gestiona las solicitudes que han enviado tus clientes</p>
            </div>
          </div>
          <div className="sr-header-stat">
            <span className="sr-total-num">{solicitudes.length}</span>
            <span className="sr-total-lbl">recibidas</span>
          </div>
        </header>
        ...
        {solicitudes.length === 0 ? (
          <div className="sr-empty">
            ...
            <p>Cuando los clientes te contacten, sus solicitudes aparecerán aquí</p>
          </div>
        ) : (
          <>
                      ...
                      >
                        ...
                        <div className="sr-card-top">
                          <div className="sr-cliente-info">
                            {sol.foto_cliente ? (
                              ...
                              <FaUserCircle className="sr-avatar-placeholder" />
                            )}
                            <div>
                        ...
                        <div className="sr-detalles-grid">
                          ...
                          <div className="sr-detalle">
                            ...
                            <div>
                              <span className="sr-d-lbl">Recibida el</span>
                        ...
                        {abierta && (
                          <div className="sr-extra">
                            <div className="sr-extra-grid">
                              ...
                              {sol.mensaje_cliente && (
                                <div className="sr-extra-item" style={{ gridColumn: "1 / -1" }}>
                                  <span className="sr-extra-item-lbl">Mensaje del cliente</span>
                        ...
                        {sol.precio_propuesto && (
                          <div className="sr-propuesta">
                            <div className="sr-propuesta-header">
                              <FaEnvelopeOpenText />
                              <span>Tu propuesta enviada</span>
                            </div>
